									 ...
									 <table class="table-bordered table-striped table-condensed flip-content" width="100%">
										 ...
										 <tbody>
											 ...
											 <tr>
												 ...
												 <td class="text-center"><span style="color:green;"><i class="icon-money"></i></span> <?php echo $userinfo['ui_ticket_balance']; ?> <a href="http://cn.mmobar.com/home/ticket_charge.php">充值</a></td>
